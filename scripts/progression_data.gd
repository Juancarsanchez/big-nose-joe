...
const UPGRADES := [
	...
	{"id":"smart_clump", "phase":1, "requires_upgrade":"cart", "name":"APELMAZADO INTELIGENTE", "desc":"Los glóbulos compactan granos normales en bolas de carga blandas. No crea pedruscos ni sustituye a los cascos azules.", "base":1800.0, "growth":3.0, "kind":"smart_clump", "power":1.0, "max":4},
	...
	{"id":"cart_reinforced", "phase":1, "requires_upgrade":"cart", "name":"EJES VESICULARES REFORZADOS", "desc":"El mismo carrito cuadruplica su carga inicial sin crear otra unidad.", "base":1500.0, "growth":1.0, "kind":"transport_capacity", "power":48.0, "max":1},
	{"id":"cart_upgrade", "phase":1, "requires_upgrades":["cart_reinforced", "puncher"], "name":"CARGA VESICULAR COMPRIMIDA", "desc":"El carrito prensa la carga y da el primer salto logístico de verdad.", "base":2600.0, "growth":1.0, "kind":"transport_capacity", "power":180.0, "max":1},
	...
	{"id":"shift", "phase":1, "requires_any_upgrades":["cart_upgrade", "punch_union"], "name":"AUTOVÍA LINFÁTICA", "desc":"Acelera un 60% los peones y duplica todo el transporte terrestre.", "base":3500.0, "growth":1.0, "kind":"speed", "power":1.0, "max":1},
	...
	{"id":"ox_convoy", "phase":2, "requires_upgrade":"silo", "name":"MUGIDÓFILO DE CARGA", "desc":"Una célula-buey tira de tres carros y transporta seiscientas unidades.", "base":12000.0, "growth":1.0, "kind":"transport_ox", "power":600.0, "max":1},
