...
const UPGRADES := [
	...
	{"id":"cart_upgrade", "phase":1, "requires_upgrades":["cart", "puncher"], "name":"REMOLQUE VESICULAR", "desc":"Añade un segundo vagón al carrito y triplica su carga conjunta.", "base":2000.0, "growth":1.0, "kind":"transport_trailer", "power":36.0, "max":1},
	...
	{"id":"breaker", "phase":2, "name":"CASCO AZUL REGLAMENTARIO", "desc":"Especializa peones para abrir apelmazados; cuanto más minas, más necesarios se vuelven.", "base":850.0, "growth":2.25, "kind":"specialist", "power":1.0, "max":3},
	{"id":"silo", "phase":2, "requires_upgrade":"cart", "name":"SILO DE NIEVE ESTRATÉGICA", "desc":"Almacena hasta cincuenta mil unidades para compras de verdad.", "base":4000.0, "growth":1.0, "kind":"storage", "power":50000.0, "max":1},
