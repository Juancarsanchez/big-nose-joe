...
const UPGRADES := [
	...
	{"id":"pawn", "phase":1, "unlock_at":35.0, "name":"OTRO PEÓN BÁSICO", "desc":"Añade otro ciclo visible de raspado, recogida y transporte.", "base":70.0, "growth":3.2, "kind":"pawn", "power":1.0, "max":8},
	...
	{"id":"smart_clump", "phase":1, "requires_upgrade":"cart", "name":"APELMAZADO INTELIGENTE", "desc":"Los glóbulos compactan granos normales en bolas de carga blandas. No crea pedruscos ni sustituye a los cascos azules.", "base":2400.0, "growth":3.4, "kind":"smart_clump", "power":1.0, "max":5},
