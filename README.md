...
La escala es universal desde cinco unidades: una unidad lógica de cocaína equivale a un píxel de pantalla de superficie en cualquier estado visible. Existe una única excepción de legibilidad: las cantidades de 1, 2, 3 o 4 se dibujan siempre con cuatro píxeles, aunque conservan intacto su valor lógico. Desde 5 la progresión vuelve a ser exactamente lineal; un impacto de 10 genera diez píxeles y una carga de 100 conserva cien durante la caída, en la pila, sobre el portador y durante la descarga. No existen bolas con un valor oculto ni nieve decorativa que altere el volumen aparente fuera de esa excepción explícita. Cada descarga engorda la superficie bajo su punto real de aterrizaje; las zonas cercanas se funden y las lejanas forman lomas separadas con valles. Los pedruscos son la única forma compactada: conservan exactamente la misma superficie opaca que las unidades que retiran de la pila. El tabique actúa como límite duro y ninguna masa puede cruzarlo.
