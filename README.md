...
El primer púgil entra con guante rojo y cinta azul, calienta el brazo, atraviesa físicamente la zona de trabajo y suelta siempre diez partículas. Los cuatro rangos producen respectivamente diez bolas de 5, 10, 20 y 50 unidades: impactos totales de 50, 100, 200 y 500. Esa fórmula permanece interna: el impacto solo muestra el daño total. Cada evolución incorpora capas visibles de guante, cinta, cinturón, insignia y aura, y solo puede comprarse una evolución nueva por fase. Después llegan tres saltos deliberadamente absurdos: el `PAQUIDERMO LEUCOCITARIO` camina hasta la pared y embiste 120.000 cada veinte segundos; el `CAÑÓN DE CÉLULAS PÚGIL` dispara 750.000 cada catorce; y el `LEUCOCITO SUPERSAIYAN` carga un Kamehameha de 50 millones cada cincuenta. Sus mejoras multiplican esos impactos por cinco, seis y diez respectivamente.
