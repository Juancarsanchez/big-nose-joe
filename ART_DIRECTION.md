...
El peón básico, el carrito, el `MUGIDÓFILO DE CARGA` y el `EXPRESO LEUCOCITARIO` son transporte puro: el carrito evoluciona 12 → 60 → 300 → 1.500 y el Mugidófilo 10.000 → 50.000 → 125.000. Ninguno daña paredes ni bloques. Estas mejoras no crean unidades nuevas: se leen mediante el número de carga y ligeros cambios de escala del edificio receptor. El espacio físico crece 1.000 → 5.000 → 25.000 → 100.000 → 2 millones → 10 millones → 500 millones; cada instalación aumenta ligeramente de tamaño y conserva su propio rótulo y cifra exacta.
