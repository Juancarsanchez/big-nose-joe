...
Solo el peón básico rasca un punto de pared en cada ciclo. El carrito, el `MUGIDÓFILO DE CARGA` y el `EXPRESO LEUCOCITARIO` son transporte puro: el carrito evoluciona de 12 a 48 y 180, el Mugidófilo mueve 600 y el Expreso toma todo el polvo normal disponible. Ninguno daña paredes ni bloques. Un bloque caído detiene sus rutas hasta que el jugador lo destruye. El espacio de almacenamiento también es físico y finito: 1.000 en la caja, 5.000 y luego 15.000 en el contenedor, 50.000 en el silo y 500.000 en la planta.
